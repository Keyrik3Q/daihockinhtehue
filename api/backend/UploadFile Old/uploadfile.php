...
$CONFIG = '{"lang":"vi","error_reporting":false,"show_hidden":false,"hide_Cols":true,"calc_folder":false}';
...
//Application Title
define('APP_TITLE', 'HCE File Manager');
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    function getUploadExt() {
        ...
        if(FM_UPLOAD_EXTENSION && $extArr) {
			...
			array_walk($extArr, create_function('&$x','$x = ".$x";'));
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo htmlspecialchars(FM_SELF_URL) . '?p=' . fm_enc(FM_PATH) ?>" class="dropzone card-tabs-container" id="fileUploader" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="namefolder" value="<?php echo fm_enc(FM_PATH) ?>">
        ...
        Dropzone.options.fileUploader = {
            ...
            init: function () {
                this.on("sending", function (file, xhr, formData) {
                    ...
                    //set copy link
                    var nameUrl = '/new/UploadFile'+ '/' + document.getElementById("namefolder").value;
                    let str = nameUrl + "/" + document.getElementById("fullpath").value; 
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> HCE File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <input type="hidden" id="namefolder1<?php echo $index ?>" value="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>">            
                        <a title="<?php echo lng('CopyLink') ?>" onclick="myCopy(<?php echo $index ?>)" style="cursor: pointer;">
                               ...
                               // set localStorage Link                           
                               function myCopy(index) {  
                                let str = '/new/UploadFile' + document.getElementById("namefolder1"+index).value.slice(16);                                 
                                const el = document.createElement('textarea');
                                el.value = str;
                                document.body.appendChild(el);
                                el.select();
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">HCE File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">HCE File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
