...
export class ApiService { 
    ...
    public getDateAndTime: string = this.formatDate(new Date()) + '\x20' + new Date().getHours() + ":" + (new Date().getMinutes() < 10 ? "0" + new Date().getMinutes() : new Date().getMinutes()) + ":" + "00";
    SERVER_URL: string = "http://hoctienganhphanxa.com/hce/hce-api/src/Controller/Upload.php";
    SENTMAIL_URL: string = "http://hoctienganhphanxa.com/hce/hce-api/src/Controller/BaseMail.php";
    // authrize
    ...
    constructor(public httpClient: HttpClient,
        ...
        this.url = "http://hoctienganhphanxa.com/hce/hce-api/src/Controller/SelectAllByWhat.php";
    }
